...
public class UIVerticalScroller : MonoBehaviour
{
    ...
    public void updateChildren(int startingIndex = -1, GameObject[] arrayOfElements = null)
    {
        ...
        for (var i = 0; i < _arrayOfElements.Length; i++)
        {
            ...
            r.sizeDelta = elementSize.rect.size/1.2f;
        }
    ...
    public void Update()
    {
        ...
        for (var i = 0; i < _arrayOfElements.Length; i++)
        {
            ...
            if (minDistance == distance[i])
            {
                ...
                result = _arrayOfElements[i].GetComponentInChildren<TextMeshProUGUI>().text;
            }
        }
    ...
    {
        float deltaUp = elementSize.rect.height + 10;

        Debug.Log("dipok delya :" + deltaUp);
