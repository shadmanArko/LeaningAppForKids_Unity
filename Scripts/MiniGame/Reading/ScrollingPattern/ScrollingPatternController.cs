...
public class ScrollingPatternController : MiniGame
{
    ...
    IEnumerator GameCompleteWait()
    {
        ...
        miniGameViewController.resultViewParent.gameObject.SetActive(true);
    }
    public override void GenerateLetters()
    {
        ...
        for (int i = 0; i < length; i++)
        {
            ...
            letterContainerUI.UpButton.onClick.AddListener(letterContainerUI.ScrollUp);
            letterContainerUI.DownButton.onClick.AddListener(letterContainerUI.ScrollDown);
